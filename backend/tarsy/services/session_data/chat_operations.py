"""
Chat Operations for Session Data Service.

Handles chat-specific CRUD operations including chat creation, retrieval,
...
class ChatOperations:
    ...
    Manages chat records, user messages, and chat-related queries for
    follow-up conversations on alert sessions.
    """
    
    def __init__(self, infra: BaseSessionDataInfra):
        """
        Initialize chat operations with shared infrastructure.
    ...
    async def create_chat(self, chat: Chat) -> Chat:
        ...
        return self._infra._retry_database_operation("create_chat", _create_operation)
    ...
    async def create_chat_user_message(self, message: ChatUserMessage) -> ChatUserMessage:
        ...
        return self._infra._retry_database_operation("create_chat_user_message", _create_operation)
